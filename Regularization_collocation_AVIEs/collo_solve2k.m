function Uh = collo_solve2k(y_delta, u_exact,k, N, c, d, alpha, delta, x)
...
for n = 1:N-1
    ...
    a111 = (c1*(h*n + 1)*(c1^2 - 6*c1*c2 + 6*c2^2))/(6*(c1 - c2)^2) - (c1*(h*n - 1)*(c1^2 - 6*c1*c2 + 6*c2^2))/(6*(c1 - c2)^2);
    a112 = ((c1^2*(2*c1 + c1^2*h - 2*c1*h*n))/6 - (c1^2*c2*(c1*h - 3*h*n + 3))/6)/(c1 - c2)^2 + ((c1^2*(2*c1 + c1^2*h + 2*c1*h*n))/6 - (c1^2*c2*(c1*h + 3*h*n + 3))/6)/(c1 - c2)^2;
    a121 = ((c1^2*(2*c1 - c1^2*h + 2*c1*h*n))/6 - (c1^2*c2*(3*h*n - c1*h + 3))/6)/(c1 - c2)^2 - ((c1^2*(c1^2*h - 2*c1 + 2*c1*h*n))/6 - (c1^2*c2*(c1*h + 3*h*n - 3))/6)/(c1 - c2)^2;
    a122 = (c1^3*(h*n + 1))/(6*(c1 - c2)^2) - (c1^3*(h*n - 1))/(6*(c1 - c2)^2);
    a211 = (c2^3*(h*n + 1))/(6*(c1 - c2)^2) - (c2^3*(h*n - 1))/(6*(c1 - c2)^2);
    a212 = ((c2^2*(2*c2 - c2^2*h + 2*c2*h*n))/6 - (c1*c2^2*(3*h*n - c2*h + 3))/6)/(c1 - c2)^2 - ((c2^2*(c2^2*h - 2*c2 + 2*c2*h*n))/6 - (c1*c2^2*(c2*h + 3*h*n - 3))/6)/(c1 - c2)^2;
    a221 = ((c2^2*(2*c2 + c2^2*h - 2*c2*h*n))/6 - (c1*c2^2*(c2*h - 3*h*n + 3))/6)/(c1 - c2)^2 + ((c2^2*(2*c2 + c2^2*h + 2*c2*h*n))/6 - (c1*c2^2*(c2*h + 3*h*n + 3))/6)/(c1 - c2)^2;
    a222 = (c2*(h*n + 1)*(6*c1^2 - 6*c1*c2 + c2^2))/(6*(c1 - c2)^2) - (c2*(h*n - 1)*(6*c1^2 - 6*c1*c2 + c2^2))/(6*(c1 - c2)^2);
