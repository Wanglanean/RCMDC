...
for n = 0:N-1
    ...
    if size(c, 2) == 1
        ...
        elseif y==3
            ...
            if n<0.25/h
                error2=error2+h*((Uhn + 2*h*n - 1)^2 + 2*h*(Uhn + 2*h*n - 1) + (4*h^2)/3);
            elseif (n>=0.25/h) && (n<0.5/h)
                error2=error2+h*((Uhn - 2*h*n)^2 - 2*h*(Uhn - 2*h*n) + (4*h^2)/3);
            elseif (n>=0.5/h) && (n<0.75/h)
                error2=error2+h*((Uhn + 2*h*n - 2)^2 + 2*h*(Uhn + 2*h*n - 2) + (4*h^2)/3);
            else
                error2=error2+h*((Uhn - 2*h*n + 1)^2 - 2*h*(Uhn - 2*h*n + 1) + (4*h^2)/3);
            end
            %error2=error2+h*int((10*abs(mod(h*n + h*s, 1/5) - 1/10) - Uhn + 1)^2, s, 0, 1);
        end   
    ...
    elseif size(c, 2) == 2
        ...
        elseif y==3
            ...
            if n<0.25/h
                error2=error2+h*((2*h + Uh1/(c1 - c2) - Uh2/(c1 - c2))*(2*h*n - (Uh1*c2)/(c1 - c2) + (Uh2*c1)/(c1 - c2) - 1) + (2*h + Uh1/(c1 - c2) - Uh2/(c1 - c2))^2/3 + (2*h*n - (Uh1*c2)/(c1 - c2) + (Uh2*c1)/(c1 - c2) - 1)^2);
            elseif (n>=0.25/h) && (n<0.5/h)
                error2=error2+h*((2*h - Uh1/(c1 - c2) + Uh2/(c1 - c2))*(2*h*n + (Uh1*c2)/(c1 - c2) - (Uh2*c1)/(c1 - c2)) + (2*h - Uh1/(c1 - c2) + Uh2/(c1 - c2))^2/3 + (2*h*n + (Uh1*c2)/(c1 - c2) - (Uh2*c1)/(c1 - c2))^2);
            elseif (n>=0.5/h) && (n<0.75/h)
                error2=error2+h*((2*h + Uh1/(c1 - c2) - Uh2/(c1 - c2))*(2*h*n - (Uh1*c2)/(c1 - c2) + (Uh2*c1)/(c1 - c2) - 2) + (2*h + Uh1/(c1 - c2) - Uh2/(c1 - c2))^2/3 + (2*h*n - (Uh1*c2)/(c1 - c2) + (Uh2*c1)/(c1 - c2) - 2)^2);
            else
                error2=error2+h*((2*h - Uh1/(c1 - c2) + Uh2/(c1 - c2))*(2*h*n + (Uh1*c2)/(c1 - c2) - (Uh2*c1)/(c1 - c2) - 1) + (2*h - Uh1/(c1 - c2) + Uh2/(c1 - c2))^2/3 + (2*h*n + (Uh1*c2)/(c1 - c2) - (Uh2*c1)/(c1 - c2) - 1)^2);
            end
        end
