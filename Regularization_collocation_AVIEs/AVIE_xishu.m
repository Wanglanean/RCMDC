...
% an=int(k(n*h+c*h,n*h+v*h),v,0,c)+int(k(n*h+c*h,v*h),v,0,c)
%%%%m=2
...
%l=n
% a111=int(k(n*h+c1*h,n*h+s*h)*l1(c1-s)*l1,s,0,c1)+int(k(n*h+c1*h,s*h)*l1(c1-s)*l1,s,0,c1)
% a112=int(k(n*h+c1*h,n*h+s*h)*l1(c1-s)*l2,s,0,c1)+int(k(n*h+c1*h,s*h)*l1(c1-s)*l2,s,0,c1)
% a121=int(k(n*h+c1*h,n*h+s*h)*l2(c1-s)*l1,s,0,c1)+int(k(n*h+c1*h,s*h)*l2(c1-s)*l1,s,0,c1)
% a122=int(k(n*h+c1*h,n*h+s*h)*l2(c1-s)*l2,s,0,c1)+int(k(n*h+c1*h,s*h)*l2(c1-s)*l2,s,0,c1)
% a211=int(k(n*h+c2*h,n*h+s*h)*l1(c2-s)*l1,s,0,c2)+int(k(n*h+c2*h,s*h)*l1(c2-s)*l1,s,0,c2)
% a212=int(k(n*h+c2*h,n*h+s*h)*l1(c2-s)*l2,s,0,c2)+int(k(n*h+c2*h,s*h)*l1(c2-s)*l2,s,0,c2)
% a221=int(k(n*h+c2*h,n*h+s*h)*l2(c2-s)*l1,s,0,c2)+int(k(n*h+c2*h,s*h)*l2(c2-s)*l1,s,0,c2)
% a222=int(k(n*h+c2*h,n*h+s*h)*l2(c2-s)*l2,s,0,c2)+int(k(n*h+c2*h,s*h)*l2(c2-s)*l2,s,0,c2)
%%%%系数b
%%n=0
...
% % u_exact3= @(x) abs(mod(x,0.2)-0.1)*10 +1;
u_exact41=@(t) -2*t+1;u_exact42=@(t) 2*t;u_exact43=@(t) -2*t+2;u_exact44=@(t) 2*t-1;
% error1=int((Uh-u_exact1(n*h+s*h))^2,s,0,1)*h
% % error2=int((Uh-u_exact2(n*h+s*h))^2,s,0,1)*h
% % error5=int((Uh-u_exact3(n*h+s*h))^2,s,0,1)*h
% error41=int((Uh-u_exact41(n*h+s*h))^2,s,0,1)*h
% error42=int((Uh-u_exact42(n*h+s*h))^2,s,0,1)*h
% error43=int((Uh-u_exact43(n*h+s*h))^2,s,0,1)*h
% error44=int((Uh-u_exact44(n*h+s*h))^2,s,0,1)*h
% %%m=2
% error1=int((Uh1*l1(s)+Uh2*l2(s)-u_exact1(n*h+s*h))^2,s,0,1)*h
% error2=int((Uh1*l1(s)+Uh2*l2(s)-u_exact2(n*h+s*h))^2,s,0,1)*h
% error3=int((Uh1*l1(s)+Uh2*l2(s)-u_exact3(n*h+s*h))^2,s,0,1)*h
error41=int((Uh1*l1(s)+Uh2*l2(s)-u_exact41(n*h+s*h))^2,s,0,1)*h
error42=int((Uh1*l1(s)+Uh2*l2(s)-u_exact42(n*h+s*h))^2,s,0,1)*h
error43=int((Uh1*l1(s)+Uh2*l2(s)-u_exact43(n*h+s*h))^2,s,0,1)*h
error44=int((Uh1*l1(s)+Uh2*l2(s)-u_exact44(n*h+s*h))^2,s,0,1)*h
%error8=int((Uh1*l1(s)+Uh2*l2(s)-u_exact3(n*h+s*h))^2,s,0,1)*h
